...
$placeholder = isset($attributes['placeholder']) ? $attributes['placeholder'] : __('Text hier eingeben...', 'copy-field');
...
<div <?php echo get_block_wrapper_attributes(['class' => 'copy-field-wrapper']); ?>>
	<?php if ($input_type === 'richtext-compressed'): ?>
		<div class="copy-field-content-wrapper">
			<div
				id="<?php echo esc_attr($block_id); ?>"
				class="copy-field-richtext-compressed"
