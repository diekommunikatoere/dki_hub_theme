...
const CreateFAQForm: React.FC<CreateFAQFormProps> = ({ sectionId, onFAQCreated, onCancel }) => {
		...
		<div className="create-faq-form">
			...
			<form onSubmit={handleSubmit} onKeyDown={handleKeyDown}>
				<table className="form-table">
					<tbody>
						<tr>
							...
							<td>
								<input type="text" id="faq-title" value={title} onChange={(e) => setTitle(e.target.value)} className="regular-text" placeholder={__("Enter the FAQ question...", "dki-wiki")} required disabled={isLoading} autoFocus />
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<div className="create-faq-form__editor">
									<WYSIWYGEditor value={content} onChange={setContent} placeholder={__("Enter the FAQ answer...", "dki-wiki")} disabled={isLoading} />
								</div>
							</td>
						</tr>
					</tbody>
				...
				<div className="create-faq-form__actions">
					<button type="submit" className="button button-primary" disabled={isLoading || !title.trim() || !content.trim()}>
