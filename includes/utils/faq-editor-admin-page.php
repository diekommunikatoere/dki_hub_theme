...
function dki_wiki_enqueue_faq_editor_assets( $hook ) {
    ...
    $js_file = get_stylesheet_directory() . '/includes/js/admin/faq-editor/faq-editor.js';
    $css_file = get_stylesheet_directory() . '/includes/css/admin/faq-editor.css';
    
    if ( file_exists( $js_file ) ) {
        wp_enqueue_script(
            'dki-faq-editor',
            get_stylesheet_directory_uri() . '/includes/js/admin/faq-editor/faq-editor.js',
        ...
        if ( file_exists( $css_file ) ) {
            wp_enqueue_style(
                'dki-faq-editor',
                get_stylesheet_directory_uri() . '/includes/css/admin/faq-editor.css',
                array(),
                filemtime( $css_file )
            );
        }
